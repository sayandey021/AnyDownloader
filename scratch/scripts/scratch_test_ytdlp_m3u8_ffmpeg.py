...
info_dict = {
    '_type': 'video',
    'id': 'test_vid_ffmpeg',
    'title': 'Test Video FFmpeg',
    'formats': [{'url': url, 'ext': 'mp4', 'protocol': 'm3u8', 'vcodec': 'video', 'acodec': 'none'}]
}

print("Running yt-dlp process_ie_result with m3u8 protocol (ffmpeg)...")
try:
